...
interface NewIncidentFormAdvancedProps {
  preselectedProjectId?: string;
}

const NewIncidentFormAdvanced = ({ preselectedProjectId }: NewIncidentFormAdvancedProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create a temporary ID for photos
      ...
      // Create the description based on added concepts
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Project selector - only appears if no project is preselected */}
          {!projectId && (
            <ProjectSelector
          ...
          {/* Project information - only if project is selected */}
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2">{project.model}</span>
                </div>
                <div>
                  <span className="text-blue-700 font-medium">Potencia:</span>
                  <span className="ml-2">{project.power || 'N/A'}</span>
                </div>
              </div>
            </div>
          )}
...
export default NewIncidentFormAdvanced;