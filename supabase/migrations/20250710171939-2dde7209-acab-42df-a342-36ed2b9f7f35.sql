-- Crear funciones para generar códigos automáticos
...
BEGIN
  ...
  client_code := 'CL_' || year_suffix || '_' || LPAD(next_number::TEXT, 3, '0');
...
BEGIN
  ...
  project_code := 'PR_' || year_suffix || '_' || LPAD(next_number::TEXT, 3, '0');
