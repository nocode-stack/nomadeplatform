-- Crear tabla NEW_Comments con la estructura del CSV
CREATE TABLE public.NEW_Comments (
  ...
  CONSTRAINT fk_new_comments_user FOREIGN KEY (user_id) REFERENCES public.user_profiles(user_id) ON DELETE CASCADE,
  CONSTRAINT fk_new_comments_tagged_user FOREIGN KEY (tagged_user_id) REFERENCES public.user_profiles(user_id) ON DELETE SET NULL
);
