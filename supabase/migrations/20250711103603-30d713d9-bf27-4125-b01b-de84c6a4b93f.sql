...
DROP INDEX IF EXISTS "idx_new_comments_project_id";
DROP INDEX IF EXISTS "idx_new_comments_user_id";
DROP INDEX IF EXISTS "idx_new_comments_tagged_user_id";
DROP INDEX IF EXISTS "idx_new_comments_created_at";

-- Limpiar tabla y función si existen
DROP TABLE IF EXISTS public."NEW_Comments" CASCADE;
DROP FUNCTION IF EXISTS public.update_new_comments_updated_at() CASCADE;
