...
BEGIN
    ...
    LOOP
        ...
        SELECT id INTO user_id FROM auth.users WHERE email = user_record.email;
        ...
        IF user_id IS NOT NULL THEN
            ...
            VALUES (user_id, user_record.name, user_record.email, user_record.department)
    ...
    RAISE NOTICE 'Usuarios corporativos actualizados correctamente';
END $$;