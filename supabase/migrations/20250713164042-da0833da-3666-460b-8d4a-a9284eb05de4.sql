-- Primero limpiar las referencias existentes
UPDATE public."NEW_Budget" SET electric_system_id = NULL WHERE electric_system_id IS NOT NULL;

-- Ahora sí podemos limpiar electric_systems
DELETE FROM public."electric_systems";

-- Limpiar NEW_Budget_Packs existentes
DELETE FROM public."NEW_Budget_Packs";

-- Crear estructura correcta: TODO COMO PACKS
