-- 1. Primero eliminar foreign key constraints problemáticas
...
-- 4. Mover TODOS los conceptos de Available a Items antes de eliminar tablas
...
-- 5. AHORA eliminar tablas innecesarias (sin conflictos de FK)
